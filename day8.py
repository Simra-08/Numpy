# ---------------------- DAY 8 ----------------------------------
# Description : Learned how to combine and split NumPy arrays using concatenation and 
# stacking,
# organize data with sorting, search arrays using np.where(), and 
# identify unique values 
# and their frequencies using np.unique().
# Applied these operations to simple data-analysis problems.
